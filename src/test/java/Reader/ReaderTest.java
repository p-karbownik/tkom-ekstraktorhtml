...
public class ReaderTest
{
    ...
    public void secondTest() throws IOException{
        ...
        assertAll("Sixth character",
                () -> assertEquals(character6, 'e'),
                () -> assertEquals(new Position(1,14), reader.getCurrentPosition())
        );
        ...
        assertAll("Seventh character",
                ...
                () -> assertEquals(new Position(1,15), reader.getCurrentPosition())
        );
    }
    ...
    public void fourthTest() throws IOException{
        ...
        assertAll("Tenth character",
                ...
                () -> assertEquals(new Position(2,12), reader.getCurrentPosition())
        );
        ...
        assertAll("Eleventh character",
                ...
                () -> assertEquals(new Position(2,13), reader.getCurrentPosition())
        );
